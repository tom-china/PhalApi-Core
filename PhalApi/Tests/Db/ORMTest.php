<?php
	 ...
	 *
	 * 针对 ../../PhalApi/DB/NotORM.php ORM 类的PHPUnit单元测试
	 *
	...
	class ORMTest extends TestCase {
		...
		public function testTransactionCommit() {
			...
			//Step 2: 数据库操作
			$this->notorm->demo->insert( [ 'name' => 'commit at ' . $_SERVER['REQUEST_TIME'] ] );
			$this->notorm->demo->insert( [ 'name' => 'commit again at ' . $_SERVER['REQUEST_TIME'] ] );
		...
		public function testTransactionRollback() {
			...
			//Step 2: 数据库操作
			$this->notorm->demo->insert( [ 'name' => 'test rollback' ] );
		...
		public function testInsertMulti() {
			$rows = [
				[ 'name' => 'A君', 'age' => 12, 'note' => 'AA' ],
				[ 'name' => 'B君', 'age' => 14, 'note' => 'BB' ],
				[ 'name' => 'C君', 'age' => 16, 'note' => 'CC' ],
			];
		...
		protected function setUp() {
			...
			$this->notorm = new ORM( DI()->config->get( 'dbs' ) /** , true **/ );
		}
